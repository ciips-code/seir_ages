...
setParameters <- function () {
  ...
  porcentajeCasosGraves_base <<- getMatrixForRow(c(0.003634, 0.003644, 0.005372, 0.008520, 0.025740, 0.044253, 0.099200, 0.205628)) # Cita:
  porcentajeCasosCriticos_base <<- getMatrixForRow(c(0.000966,0.000969,0.001428,0.00348,0.01326,0.024747,0.0608,0.094372)) # Cita:
  porcAsignadoCovid <<- .7 # Cita:
  ifr_base <<- c(8.8e-05,0.000284,0.000745,0.001868,0.004608,0.011231,0.026809,0.079684) # (por edad) Cita:
  ...
  transmission_probability_base <<- matrix(c(0.2299, 0.2413, 0.2527, 0.266, 0.2831, 0.3097, 0.3211, 0.3211,
  ...
  colnames(transmission_probability_base) <- rownames(transmission_probability_base) <<- ageGroups
